...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('plugins/ueditor/dialogs/emotion/emotion.css')}}">
</head>
<body>
...
<div id="tabIconReview">
    <img id='faceReview' class='review' src="{{asset('plugins/ueditor/themes/default/images/spacer.gif')}}"/>
</div>
<script type="text/javascript" src="{{asset('plugins/ueditor/dialogs/emotion/emotion.js')}}"></script>
