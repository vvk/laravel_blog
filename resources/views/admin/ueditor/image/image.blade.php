...
<head>
    ...
    <!-- image dialog -->
    <link rel="stylesheet" href="{{asset('plugins/ueditor/dialogs/image/image.css')}}" type="text/css" />
</head>
<body>
    ...
    <script type="text/javascript" src="{{asset('plugins/ueditor/dialogs/image/image.js')}}"></script>
</body>
</html>