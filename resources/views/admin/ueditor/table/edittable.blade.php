...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('plugins/ueditor/dialogs/table/edittable.css')}}">
</head>
<body>
<div class="wrapper">
    <div class="left">
...
<script type="text/javascript" src="{{asset('plugins/ueditor/dialogs/table/edittable.js')}}"></script>
</body>
</html>