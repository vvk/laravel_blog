...
<head>
    ...
    <link rel="stylesheet" href="{{asset('plugins/ueditor/dialogs/music/music.css')}}" type="text/css" />
</head>
<body>
<div class="wrapper">
    <div class="searchBar">
...
<script type="text/javascript" src="{{asset('plugins/ueditor/dialogs/music/music.js')}}"></script>
